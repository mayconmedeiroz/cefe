$(document).ready(function () {
    ...
    $(document).on('change', '#sport', function() {
        ...
        if(sportId) {
            $.ajax({
                url: ($('#sport-class-form').on('submit') && $('#action_button').val() === "Modificar") ? `/sport_classes/getSportName/${sportId}/${classId}` : `/sport_classes/getSportName/${sportId}/0`,
                type: 'GET',
                dataType: 'json',
