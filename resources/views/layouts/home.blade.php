            ...
            <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
                <div class="container">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ml-auto">
                            <a href="{{ route('login') }}" class="small btn btn-primary btn-red px-4 py-2 rounded-0"><span class="icon-user"></span> Acessar</a>
                    ...
                    <div class="col-12">
                        <div class="copyright py-0">
                            ...
                            <p class="m-0">
                                ...
                                Copyright &copy;2019 Todos os direitos reservados. | Template feito por <a href="https://colorlib.com" target="_blank">Colorlib</a>
                                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                            </p>
                        </div>
                    </div>
