...
@section('content')
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('{{ asset('img/global/bg_1.jpg') }}');padding-top: 8em;">
        <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="post-entry-big">
                            <a href="/blog/{{ $post->id }}" class="img-link"><img src="/storage/posts/{{ $post->image }}" alt="Image" class="img-fluid"></a>
