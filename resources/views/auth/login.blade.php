...
<div class="container-fluid">
    <div class="row container-left-background">
        ...
        <div id="login" class="col-md-6 bg-light">
            <div class="d-table w-100 mx-auto container-right">
                <form class="d-table-cell align-middle" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group">
                        <input placeholder="Email" id="email" type="email" value="{{ old('email') }}" class="form-control" name="email" required autocomplete="email" autofocus>
                    </div>
                    <div class="form-group">
            ...
            <hr class="mx-5"/>
            <p class="text-center">Lorem ipsum dolor <a class="" href="#">sit amet</a></p>
        </div>
