...
<div class="row mb-3">
    <div class="col-md-3">
        <div class="tile-stats tile-blue">
            ...
            <div class="tile-num">{{ \CEFE\Student::count() }}</div>
            <h3>Alunos</h3>
            <p>Total de alunos</p>
        </div>
    </div>
    <div class="col-md-3">
        <div class="tile-stats tile-hoki">
            ...
            <div class="tile-num">{{ \CEFE\StudentClass::count() }}</div>
    ...
    <div class="col-md-3">
        <div class="tile-stats tile-red">
            ...
            <div class="tile-num">{{ \CEFE\SportClass::count() }}</div>
            <h3>Turmas</h3>
            <p>Total de turmas</p>
        </div>
    </div>
...
@section('custom-js')
    ...
    <script>
        $(document).ready(function () {
            ...
            calendar.render();
            $('.fc-left').html('<h5>Calendário Escolar</h5>');
        });
    </script>
@endsection